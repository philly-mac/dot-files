@bundles = [
  ...
  ['ctrlp.vim',    'https://github.com/kien/ctrlp.vim.git' ],        # Quick seaching through the project files
  ...
  ['supertab',     'https://github.com/ervandew/supertab.git'],      # All completion done via tab key
